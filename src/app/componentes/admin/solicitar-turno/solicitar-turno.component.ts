...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, HoraFormatPipe, FechaHoraFormatPipe, FormsModule],
...
export class SolicitarTurnoComponent {
  ...
  ngOnInit(): void {
    ...
    this.pacServ.obtenerPacientes().subscribe( pac => this.pacientes = pac);
  }
  ...
  seleccionarPaciente(event: Event) {
    ...
    if (target && target.value) {
      this.pacienteEmail = target.value;
    }
  }
